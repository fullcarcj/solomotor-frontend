...
export default function TipoFConfigPanel() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const res = await fetch("/api/automatizaciones/config/tipo-f", {
        credentials: "include",
        cache: "no-store",
      });
  ...
  return (
    <div>
      ...
      <div className="alert alert-info small mb-3">
        ...
        Para modificar la configuración de Tipo F, contactar al administrador del sistema.
      </div>
