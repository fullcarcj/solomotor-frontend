...
/** Proxy PATCH → webhook-receiver /api/inventory/pricing/settings/policy/{channel} */
export async function PATCH(req: NextRequest, context: RouteCtx) {
  ...
  try {
    ...
    const upstream = await fetch(
      `${base}/api/inventory/pricing/settings/policy/${channel}`,
      {
        method: "PATCH",
        headers: {
    ...
    console.error(`[api/inventory/pricing/settings/policy/${channel} PATCH]`, e);
