...
/** Proxy PATCH → webhook-receiver /api/inventory/pricing/settings/financial */
export async function PATCH(req: NextRequest) {
  ...
  try {
    ...
    const upstream = await fetch(
      `${base}/api/inventory/pricing/settings/financial`,
      {
        method: "PATCH",
        headers: {
    ...
    console.error("[api/inventory/pricing/settings/financial PATCH]", e);
