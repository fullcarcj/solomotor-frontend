...
/** Proxy GET → webhook-receiver /api/inventory/pricing/spread-alert */
export async function GET() {
  ...
  try {
    const upstream = await fetch(`${base}/api/inventory/pricing/spread-alert`, {
      method: "GET",
    ...
    console.error("[api/inventory/pricing/spread-alert GET]", e);
