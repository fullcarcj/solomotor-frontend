...
/** BFF → POST /api/inbox/quotations/from-sales-order (borrador desde sales_orders, sin chat obligatorio). */
export async function POST(req: NextRequest) {
  ...
  const targetUrl = `${base()}/api/inbox/quotations/from-sales-order`;
  try {
    ...
    console.error("[BFF quotations/from-sales-order POST]", e);
